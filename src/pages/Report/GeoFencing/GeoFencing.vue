    ...
    <div>
        <b-row>
            ...
            <b-col cols="2 offset-6">
                <div class="km_button">
                    <button @click="update1" class="btn btn-outline-default mr-4">Upto 10 Km</button>
                    <button @click="update2" class="btn btn-outline-default">Upto 50 Km</button>
                </div>
            </b-col>
        </b-row>
        <b-row>
            <b-col cols="12 mt-3">
                ...
                >
                    ...
                    :clickable="true" :title="marker.title" :draggable="true"/>  
                <GmapCluster :grid-size="gridSize" :styles="clusterStyles" :clickable="true">
                    <GmapMarker v-for="(marker, index) in markers1" :key="index" :icon="marker.icon" :position="marker.latLng"
                    ...
                    <GmapCircle
                        ...
                        :clickable="false"
                        ref="circleRef"
                        :options="{fillColor:'#808080',fillOpacity:0.6,strokeColor:'transparent'}"
                    ></GmapCircle>
                    <GmapCircle
                        v-for="(pin) in markers"
                        :key="pin.latLng.lng"
                        ...
                        :clickable="false"
                        ref="circleRef"
                        :options="{fillColor:'#808080',fillOpacity:0.4,strokeColor:'transparent'}"
                    ></GmapCircle>
                </GmapMap>
            </b-col>
        </b-row>
            ...
            mark(event){
                ...
                const position={
                    ...
                    for(let i=0; i<this.markers1.length; i++){
                        var markerPosition = {lat:this.markers1[i].latLng.lat, lng:this.markers1[i].latLng.lng}
                        ...
                        var check = this.checkCircleInMarker(markerPosition, circlePosition, circleRadius);
                        if (check) {
